...
* L'exportation de volumes ou de LUN en tant que datastores sur différents clusters avec les mêmes adresses IP dans une configuration de LIF multiples n'est pas prise en charge car UM ne peut pas identifier le datastore qui appartient à quel cluster.
+

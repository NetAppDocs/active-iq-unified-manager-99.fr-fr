...
* Red Hat Enterprise Linux ou CentOS version 7.x et 8.x, basé sur l'architecture x86_64
...
* MySQL Community Edition version 8.0.25 (à partir du référentiel MySQL).
* OpenJDK version 11.0.9 (à partir du référentiel Red Hat Extra Enterprise Linux Server)
* Python 3.6.x

...
* <<reference-health-volume-details-page,Volet groupes associés>>
...
** Protégé par
+
Affiche le type de protection utilisé pour le volume sélectionné. Ce champ est également doté d'un lien qui vous redirige vers la page de relations avec ses relations de reprise après incident des machines virtuelles de stockage. Ce lien ne s'applique qu'aux relations constitutives.
